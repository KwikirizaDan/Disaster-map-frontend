...
const ReportDisaster = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:5000/api/disasters', payload, {
        headers: {
      ...
      toast.error('There was a problem submitting your report. Please try again.');
    } finally {
      setIsSubmitting(false);
    }
  };
          ...
          <main className="flex flex-1 justify-center py-10">
            <div className="w-full max-w-2xl">
              <div className="bg-white rounded-xl shadow-sm p-8">
                <h1 className="text-gray-900 tracking-light text-3xl font-bold leading-tight mb-6">Report a Disaster</h1>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {step === 1 && (
                    <div className="space-y-6">
                      <div>
                        <h2 className="text-xl font-semibold mb-4">Upload Disaster Image</h2>
                        <p className="text-gray-600 mb-6">Please upload an image of the disaster first. This will help us better understand the situation.</p>
                  ...
                  {step === 2 && (
                    <div className="space-y-6">
                      <div>
                        <h2 className="text-xl font-semibold mb-4">Enter Disaster Details</h2>
                        <p className="text-gray-600 mb-6">Please provide detailed information about the disaster.</p>
                      </div>
